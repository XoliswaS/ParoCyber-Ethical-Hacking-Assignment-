...
**Why this exploit?** 
VSFTPD 2.3.4 contains a backdoor that was maliciously inserted into the source code. It opens a shell on port 6200 when triggered, allowing remote command execution.
